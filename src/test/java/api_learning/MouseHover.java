...
public class MouseHover implements IUrls {
        ...
        try {
            ...
            if (figureElems.isEmpty())
                ...
                for (WebElement figureElem : figureElems) {
                    ...
                    WebElement figureElemElement = figureElem.findElement(figureImgSel);
                    String figureImgSrc = figureElemElement.getAttribute("src");
                    WebElement figureDescElement = figureElem.findElement(figureDescSel);
                    String figureDesc = figureDescElement.getText();
                    WebElement figureImgLinkElement = figureElem.findElement(figureImgLinkSel);
